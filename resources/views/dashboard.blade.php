            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <p class="mt-6 text-gray-500 leading-relaxed">
                        內部專用短網址服務，將長網址轉換為短網址。
                    </p>
                    <div>
{{--                        <label for="email" class="block text-sm font-medium leading-6 text-gray-500">URL</label>--}}
                        <form class="mt-2 flex-col flex" action="{{ route('url.store') }}" method="post">
                            <input type="url" name="url" id="url"
                                   class="block rounded-t-md border-0 py-1.5 text-gray-500 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                   placeholder="https://esgltc.com">
                            <input type="text" name="code" id="code"
                                   class="block border-0 py-1.5 text-gray-500 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                   placeholder="A_RANDOM_CODE">
                            <button
                                class="inline-flex items-center px-4 py-2  text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-b-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                一鍵縮
                            </button>
                            @csrf
                        </form>
